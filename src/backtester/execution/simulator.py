"""src/backtester/execution/simulator.py
...
from backtester.core.events import Direction, FillEvent, MarketDataEvent, OrderEvent
from backtester.execution.impact import MarketImpactModel, NoMarketImpact
from backtester.execution.slippage import SlippageModel, ZeroSlippage
